...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <p>
        <asp:GridView ID="GridView1" runat="server" Width="1573px" 
            ...
            <Columns>
                <asp:BoundField DataField="Project_ID" HeaderText="Project ID" ReadOnly="true" />
...
<ControlStyle CssClass="btn btn-primary"></ControlStyle>
               ...
               <asp:TemplateField HeaderText="View Team">
                <ItemTemplate>
                    <asp:Button ID="ViewTeam" runat="server" onclick="ViewTeam_Click" Text="ViewTeam" ControlStyle-CssClass="btn btn-info"/>
                </ItemTemplate>
            </asp:TemplateField>
